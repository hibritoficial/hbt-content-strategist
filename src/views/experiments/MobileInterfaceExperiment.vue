  ...
  <div class="experiment-page">
    <div class="experiment-header">
      <div class="breadcrumb-nav">
        ...
        <span class="breadcrumb-current">Mobile Interface</span>
      </div>
      
      <div class="experiment-info">
        <h1>📱 Mobile Interface - Otimizada para Mobile</h1>
    ...
    <KnowledgeSystem experiment-type="mobile-interface" experiment-name="Mobile Interface" />
    <OtherExperiments current-experiment="mobile-interface" />
  </div>
</template>
...
const exportInterface = () => {
  console.log('Export Mobile Interface')
}
