  ...
  try {
    ...
    if (!editingItem.value) {
      ...
      if (dialogType.value === 'pillar') {
        await libraryStore.createPillar(data, workspaceStore.currentWorkspace?.id)
      } else if (dialogType.value === 'angle') {
        await libraryStore.createAngle(data, workspaceStore.currentWorkspace?.id)
      } else if (dialogType.value === 'mold') {
        await libraryStore.createMold(data, workspaceStore.currentWorkspace?.id)
...
const seedInitialData = async () => {
  ...
  try {
    ...
    await libraryStore.loadAll(workspaceStore.currentWorkspace?.id)
...
onMounted(async () => {
  ...
  if (workspaceStore.currentId) {
    await libraryStore.loadAll(workspaceStore.currentId)
  }
})
</script>