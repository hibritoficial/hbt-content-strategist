<template>
  <div class="cxa-dashboard">
      ...
      <div class="header-content">
        ...
        <div class="dashboard-info">
          ...
          <div class="dashboard-actions">
            <button class="open-interface-btn" @click="$router.push('/labs/components-test')">
              <v-icon size="16">mdi-test-tube</v-icon>
              <div class="btn-content">
                <span class="btn-title">TESTES DE COMPONENTES</span>
                <span class="btn-subtitle">Laboratório dedicado para testes visuais de componentes</span>
              </div>
            </button>
    ...
    <div id="interface-capture" class="interface-container">
      ...
      <!-- Outros Experimentos de Interface -->
